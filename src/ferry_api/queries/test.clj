...
(defn json2edn [data]
  (let [writemessage (json/write-str data)
        readmessage (json/read-str writemessage)
        parsemessage (parse-string readmessage true)]
...
(defn edn2json [data]
  (let [mapmessage (into {} data)
        jsonmessage (json/write-str mapmessage)]
    (println "data: " data)
    (println "mapified message: " mapmessage)
    (println "json/message:" jsonmessage))
